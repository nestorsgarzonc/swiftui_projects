...
struct Stories {
    ...
    init(){
        startNode.add(child: storyChoice1)
        startNode.add(child: storyChoice2)
        storyChoice1.add(child: story1Choice1)
        storyChoice1.add(child: story2Choice1)
        storyChoice2.add(child: story1Choice2)
        storyChoice2.add(child: story2Choice2)
        story1Choice2.add(child: sub1Story1Choice2)
        story1Choice2.add(child: sub2Story1Choice2)
    }
